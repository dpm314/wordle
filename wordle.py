...
class WordleBoard:
    ...
    def printDiagnostics(self, printCurrentWordList=False):
        ...
        for _ in range(self.lineLength):
            if not self.printNothing:
                print(
                    "Letters Available at Location {}: {}".format(_, self.available[_])
                )
...
for i in range(numGames):
    ...
    if b.WON:
        print(LETTER_COLOR_DICT[2] + "#{} answer: {} \t".format(i, b.ANSWER.upper()), end="")
    else:
        print(LETTER_COLOR_DICT[0] + "#{} answer: {} \t".format(i, b.ANSWER.upper()), end="")
endTime = time.time()
print("\n" + TXT_COLORS.DEFAULT)
...
for i in range(numGames):
    ...
    if b.WON:
        print(LETTER_COLOR_DICT[2] + "answer: {} \t".format(b.ANSWER.upper()), end="")
    else:
        print(LETTER_COLOR_DICT[0] + "answer: {} \t".format(b.ANSWER.upper()), end="")
endTime = time.time()
print("\n" + TXT_COLORS.DEFAULT)
